...
<head>
    ...
    <link rel="stylesheet" href="style.css?version=1.0.3">
...
<body>
    ...
    <div class="contenido col-sm-10 col-sm-offset-1">
        <div class="well" style="margin-top: 1%;">
            ...
            <form class="formulario" role="form" id="frmactualizar" method="POST" data-toggle="validator" class="shake">
            <div class="lista2" id="select2lista">
    
                    <div class="row">
    
                        <div class="borrar form-group col-sm-6">
                            ...
                            <div class="" id="desaparece">
                                <label id="desaparece2" for="ID_hospital" class="">ID hospital</label>
                                <input type="text" class="" id="ID_hospital"  name="ID_hospital" placeholder="ID" required>
                                <!-- <div class="help-block with-errors"></div> -->
                            </div>
                        </div>
                    </div>
                ...
                <button type="submit" id="btnactualizar" class="btn btn-success btn-lg pull-right ">Actualizar</button>
                <br>
                <hr>
